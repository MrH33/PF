...
%得到目标模板的初始数据
I=imread('C:\Users\10125\Desktop\基于粒子滤波的视频目标跟踪算法matlab源程序\matlab目标跟踪仿真程序\仿真图片1\1.bmp');
% b=I(:,:,1);
[h,s,v] = rgb2hsv(I);
imshow(I);
x1 = 1.2238e+03; 
...
F = getframe;
mkdir('C:\Users\10125\Desktop\基于粒子滤波的视频目标跟踪算法matlab源程序\matlab目标跟踪仿真程序\仿真程序\result');
image_source=strcat('C:\Users\10125\Desktop\基于粒子滤波的视频目标跟踪算法matlab源程序\matlab目标跟踪仿真程序\仿真程序\result\','1.bmp');
...
for loop=2:n
    ...
    b=[a,'.bmp'];
    b=['C:\Users\10125\Desktop\基于粒子滤波的视频目标跟踪算法matlab源程序\matlab目标跟踪仿真程序\仿真图片1\',b];
    I=imread(b);
    [H,S,V]=rgb_to_rank(I);
    %产生随机粒子
...
for new_x=round(Estimate(loop).x)-i:round(Estimate(loop).x+i)
     ...
     imshow(TargetPic);
     F = getframe;
     image_source=strcat('C:\Users\10125\Desktop\基于粒子滤波的视频目标跟踪算法matlab源程序\matlab目标跟踪仿真程序\仿真程序\result\',num2str(loop),'.bmp');
     imwrite(F.cdata,image_source);  
end
